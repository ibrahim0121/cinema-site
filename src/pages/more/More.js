...
const More = () => {
    ...
    // useEffect(() => {
    //     axios(`https://api.themoviedb.org/3/movie/${param.movie_id}?api_key=72315348c29a41a225bae93956036048&language=en-US`)
    //         .then(({data}) => {
    //             setMovieDetails(data.results)
    //             console.log(data.results)
    //         })
    // }, [])
    // console.log(MovieDetails ,"DETAIL")
    return (
        <>
            <section className="more">
                <div className="container mx-auto px-9">
                    {/*{MovieDetails.slice(0,4).map((el)=> (*/}
